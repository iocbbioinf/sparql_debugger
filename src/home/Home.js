...
function HomeCarousel() {
  ...
  return (
    <Carousel indicators={false} className="d-none d-lg-block">
      ...
      >
        ...
        >
          ...
          <p>
            ...
            search interface is fully interoperable, and may be used in
            combination with other data sources using SPARQL.
          </p>
          <p>
      ...
      <Carousel.Item
        style={{
          backgroundImage: `url(${sachemImage})`,
          backgroundSize: "cover",
        }}
      >
        <Container
        ...
        >
          ...
          <p>
            Sachem is the open-source chemical cartridge that provides the
            high-performance indexing backend for the IDSM services.
            Installations of Sachem routinely handle hundreds of millions of
            stored compounds.
          </p>
          <p>
      ...
      >
        ...
        >
          ...
          <p>
            Interoperability allows you to search through Rhea, Uniprot, ChEMBL
            and IDSM data sources at once. We provide useful SPARQL query
  ...
  return (
    <Row md={1}>
      <Col className="text-center d-flex flex-column mt-5">
        <LinkContainer to="/sparql">
          <Button variant="link">
            <Image src={sparqlIcon} width={140} height={140} roundedCircle />
            <h2>SPARQL GUI</h2>
          </Button>
        </LinkContainer>
        <p className="flex-grow-1">
          We provide an indexing service that allows FAIR-style search in
          published chemical data. You can easily construct queries that contain
          chemical substructure and similarity search terms combined with
          protein or bioassay-related queries.
        </p>
        <LinkContainer to="/sparql">
          <Button variant="secondary">
            Search with SPARQL <Icon icon={faAngleDoubleRight} />
          </Button>
        </LinkContainer>
      </Col>
  ...
  return (
    <Row className="align-items-center">
      ...
      <Col>
        ...
        <p>
          The main goal of IDSM is to aggregate many different sources of
          information about small molecules into a single, logically coherent
          and semantically interconnected information source. This is achieved
          using the semantic web technologies. The data is explored and queried
          by the SPARQL query language; allowing to search through the vast
          amount of published chemical RDF data.
        </p>
      </Col>
    </Row>
  );
  ...
  return (
    <Row className="align-items-center">
      <Col>
        ...
        <p>IDSM internals have been described in several articles:</p>
        <ul>
          <li>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://doi.org/10.1186/s13321-021-00515-1"
            >
          ...
          <li>
            ...
            <a
              target="_blank"
              rel="noreferrer"
              href="https://doi.org/10.1186/s13321-019-0367-2"
            >
